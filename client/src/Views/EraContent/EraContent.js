        ...
        {loading ? (
          ...
          <Fragment>
            ...
            <SectionCover backgroundImage={"/images/KoolHercBD.jpg"} minHeight={'70vh'} alignItem={false}>
              <SimpleText style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column' }}>
                <div>
                  <h2>IF IT WAS ICONIC IS ALSO BECAUSE OF KOOL HERC MATE COKE LA ROCK THE 1ST RAPPER OF HISTORY</h2>
                </div>
                <div>
                  <p>
                  the next day Kool Herc’s name was resounding across the Bronx. Herc’s technique was an innovation that would become the blueprint for hip-hop music.
                  </p>
                </div>
                <div>
                  <p>
                  he used a two-record turntable to spin two copies of the same record in order to elongate the “break
                  </p>
                </div>
              </SimpleText>
            </SectionCover>
            ...
            <SectionCover backgroundColor={"#561222"} alignItem={false}>
              <AlbumContainer>
                <AlbumContainerTitle>when the beats meet the rhymes</AlbumContainerTitle>
                <Album>
                  <AlbumContent>
                    <p>
                    Grandmaster Flash rapped and made the shout outs on his own at first, but he knew if he wanted to remain innovative and retain his flawless turntable technique he needed some help.<br/><br/> He worked for a short time in 1978-79 with Kurtis Blow before recruiting a few of his friends Keith (Cowboy) Wiggins, and two brothers, Melvin (Melle Mel) and the older sibling, Nathaniel (Kidd Creole) Glover. They soon began writing their own rhymes and calling themselves The Three MC’s. Over time they added in Guy (Rahiem) Williams and Eddie (Mr. Ness/Scorpio) Morris and became the legendary group Grandmaster Flash and the Furious Five.
                    </p>
                  </AlbumContent>
                ...
                <Album>
                  <AlbumContent>
                    <p>
                    One of the more impactfull song of the Furious Five is The Message. He changed the playing field for what a rap record could do. It showed that you could make things other than party songs and still sell records
                    </p>
                  </AlbumContent>
